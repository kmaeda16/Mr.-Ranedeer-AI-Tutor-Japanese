...
- 本家のMr. Ranedeerもそうですが、ある程度の回数のチャットをすると、ChatGPTが自分がMr. Ranedeerであることを忘れてしまうことがあります。具体的には、`/test`などのコマンドを打っても「よくわかりません」といった応答をすることがあります。この問題はプロンプトエンジニアリングで改善できるかもしれません。
